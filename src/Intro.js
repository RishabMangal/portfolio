...
function Intro (props) {
  return (
    <div
      className='card text-center p-2 mr-auto text-secondary bg-light info'
      style={{ marginTop: '12%', border: 'white' }}
    >
      <p className='intro m-3'>Hello! I'm Rishab</p>
      <p className='lead text-secondary discription'>
        ...
        <br></br>I Love to Develop Web Apps and Mobile Apps.Currently,I am{' '}
        <br></br>
