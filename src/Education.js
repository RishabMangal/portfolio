    ...
    <div>
      <div className='card text-center p-2 my-5' id='education'>
        ...
        <div className=''>
          ...
          >
            2018-2022
            <p className='lead text-secondary text-center'>Bachelor's Degree</p>
          </span>
          <span
          ...
          >
            ...
            <p className='text-secondary text-left font-weight-light'>
              I am pursuing B.Tech from IIIT Kota.I am a Second Year Graduate.My
              stream is Computer Science Engineering.
            </p>
          </span>
        </div>
